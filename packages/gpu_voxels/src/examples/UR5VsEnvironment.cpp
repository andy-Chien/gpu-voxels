...
int main(int argc, char* argv[])
{
  ...
  linknames[3] = paths_to_pointclouds[0] = "ur5/base.binvox";
  linknames[4] = paths_to_pointclouds[1] = "ur5/shoulder.binvox";
  linknames[5] = paths_to_pointclouds[2] = "ur5/upperarm.binvox";
  linknames[6] = paths_to_pointclouds[3] = "ur5/forearm.binvox";
  linknames[7] = paths_to_pointclouds[4] = "ur5/wrist1.binvox";
  linknames[8] = paths_to_pointclouds[5] = "ur5/wrist2.binvox";
  linknames[9] = paths_to_pointclouds[6] = "ur5/wrist3.binvox";
  ...
  dh_params[4] = robot::DHParameters(0.089159,  0.0,    0.0,          1.570796327,     0.0, robot::REVOLUTE);  //
  dh_params[5] = robot::DHParameters(0.0,       0.0,    -0.42500,     0,               0.0, robot::REVOLUTE);  //
  dh_params[6] = robot::DHParameters(0.0,       0.0,    -0.39225,     0,               0.0, robot::REVOLUTE);  //
  dh_params[7] = robot::DHParameters(0.10915,   0.0,    0.0,          1.570796327,     0.0, robot::REVOLUTE);  //
  dh_params[8] = robot::DHParameters(0.09465,   0.0,    0.0,         -1.570796327,     0.0, robot::REVOLUTE);  // Params for last Robot axis (visualized by 6_link)
  dh_params[9] = robot::DHParameters(0.0823,    0.0,    0.0,          0.0,             0.0, robot::REVOLUTE);  // Params for the not viusalized tool
  ...
  min_joint_values["ur5/base.binvox"] = -1.0;
  min_joint_values["ur5/shoulder.binvox"] = -1.0;
  min_joint_values["ur5/upperarm.binvox"] = -1.0;
  min_joint_values["ur5/forearm.binvox"] = -1.0;
  min_joint_values["ur5/wrist1.binvox"] = -1.0;
  ...
  max_joint_values["ur5/base.binvox"] = 1.5;
  max_joint_values["ur5/shoulder.binvox"] = 1.5;
  max_joint_values["ur5/upperarm.binvox"] = 1.5;
  max_joint_values["ur5/forearm.binvox"] = 1.5;
  max_joint_values["ur5/wrist1.binvox"] = 1.5;
